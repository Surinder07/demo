    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#334155] text-[#f8fafc]">
      ...
      <section className="max-w-6xl mx-auto px-4 py-16 text-center">
        <h1 className="text-5xl md:text-6xl font-extrabold mb-6">
                      Join Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400">Team</span>
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-4">
              ...
              <span className="text-cyan-300 font-semibold">🚀 Growing Company</span>
            </div>
            <div className="bg-cyan-500/20 border border-cyan-500/30 rounded-xl px-6 py-3">
              <span className="text-cyan-300 font-semibold">🌍 Remote-First</span>
            </div>
            <div className="bg-cyan-500/20 border border-cyan-500/30 rounded-xl px-6 py-3">
              <span className="text-cyan-300 font-semibold">💡 Innovation Focus</span>
            </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="space-y-6">
          {openPositions.map((position, index) => (
            <div key={index} className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-cyan-500/20 hover:border-cyan-400/40 transition-all duration-300">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h3 className="text-2xl font-bold mb-2">{position.title}</h3>
                  <p className="text-cyan-400 font-medium mb-2">{position.type}</p>
                  {position.salary && (
                    <span className="inline-block bg-cyan-500/20 text-cyan-300 px-3 py-1 rounded-lg text-sm font-semibold">
                      {position.salary}
                    </span>
                  )}
                </div>
                <button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 hover:from-cyan-600 hover:via-purple-600 hover:to-pink-600 text-white font-medium rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl"
                >
                  Apply Now
                </button>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold text-cyan-300 mb-3">Requirements</h4>
                ...
                <div>
                  <h4 className="font-semibold text-cyan-300 mb-3">Benefits</h4>
                  <ul className="space-y-2">
      ...
      <footer className="border-t border-white/10 py-8 mt-12">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href="#contact" className="px-6 py-3 bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 hover:from-cyan-600 hover:via-purple-600 hover:to-pink-600 text-white rounded-xl transition-all duration-200">
              Contact Us
            </a>
          </div>
        </div>
