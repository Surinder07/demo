    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#334155] text-[#f8fafc]">
      ...
      <section className="max-w-6xl mx-auto px-4 py-16 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
              ...
              <span className="text-cyan-300 font-semibold">📞 24/7 Support</span>
            </div>
            <div className="bg-cyan-500/20 border border-cyan-500/30 rounded-xl px-6 py-3">
              <span className="text-cyan-300 font-semibold">💬 Quick Response</span>
            </div>
            <div className="bg-cyan-500/20 border border-cyan-500/30 rounded-xl px-6 py-3">
              <span className="text-cyan-300 font-semibold">🎯 Expert Guidance</span>
            </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {contactMethods.map((method, index) => (
            <div key={index} className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-cyan-500/20 text-center hover:border-cyan-400/40 transition-all duration-300">
              ...
              {method.action !== "#" ? (
                <a 
                  href={method.action}
                  className="inline-block px-4 py-2 bg-cyan-500/20 text-cyan-300 hover:bg-cyan-500/30 rounded-lg transition-all duration-200"
                >
                  {method.details}
                </a>
              ) : (
      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className="w-full px-6 py-3 bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 hover:from-cyan-600 hover:via-purple-600 hover:to-pink-600 text-white font-medium rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          <div>
            ...
            {/* Office Hours */}
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-cyan-500/20 mb-6">
              <h3 className="text-xl font-semibold mb-4 text-cyan-300">🕒 Business Hours</h3>
              <div className="space-y-3">
                {officeHours.map((schedule, index) => (
                  <div key={index} className="flex justify-between items-center py-2 border-b border-slate-700 last:border-b-0">
                    ...
                    <span className="text-cyan-300">{schedule.hours}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* Location */}
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-cyan-500/20">
              <h3 className="text-xl font-semibold mb-4 text-cyan-300">📍 Our Location</h3>
              <div className="space-y-3">
      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-cyan-500/20">
            <h3 className="text-lg font-semibold mb-3 text-cyan-300">How quickly do you respond?</h3>
            <p className="text-sm opacity-80">We typically respond to all inquiries within 24 hours during business days.</p>
          </div>
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-cyan-500/20">
            <h3 className="text-lg font-semibold mb-3 text-cyan-300">Can I schedule a consultation?</h3>
            <p className="text-sm opacity-80">Absolutely! Call us or use the contact form to schedule a free consultation.</p>
          </div>
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-cyan-500/20">
            <h3 className="text-lg font-semibold mb-3 text-cyan-300">Do you offer remote support?</h3>
            <p className="text-sm opacity-80">Yes, we provide both in-person and remote consultation options.</p>
          </div>
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-cyan-500/20">
            <h3 className="text-lg font-semibold mb-3 text-cyan-300">What information should I include?</h3>
